...
export class ItemMenuService extends BaseResourceService {
  private route: string = `${environment.API_URL}/api/itemmenu`;

  constructor(protected injector: Injector) {
    super(`${environment.API_URL}/api/itemmenu`, injector);
  }
